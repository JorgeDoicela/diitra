...
public class AuthService : IAuthService
{
    ...
    public async Task<bool> ResendMagicLinkAsync(string email)
    {
        ...
        var emailBody = $"<p>Usted ha solicitado el reenvío de su enlace de acceso para el módulo de arbitraje científico.</p>" +
                        ...
                        $"<div style=\"margin-top: 24px; padding: 20px; background-color: #fafafa; border: 1px solid #eaeaea; border-radius: 8px;\">" +
                        $"  <h4 style=\"margin: 0 0 12px 0; color: #666666; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;\">Credenciales de Acceso Convencional</h4>" +
                        $"  <p style=\"margin: 0 0 12px 0; font-size: 13.5px; color: #333333; line-height: 1.5;\">Si prefiere iniciar sesión de forma convencional a través de la página de login principal, puede utilizar las siguientes credenciales temporales:</p>" +
                        $"  <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"margin-bottom: 12px;\">" +
                        $"    <tr>" +
                        $"      <td style=\"padding: 4px 12px 4px 0; color: #666666; font-size: 13.5px;\">Usuario:</td>" +
                        $"      <td style=\"padding: 4px 0; color: #000000; font-weight: 500; font-size: 13.5px; font-family: 'Geist Mono', monospace;\">{user.IdSigafi}</td>" +
                        $"    </tr>" +
                        $"    <tr>" +
                        $"      <td style=\"padding: 4px 12px 4px 0; color: #666666; font-size: 13.5px;\">Contraseña:</td>" +
                        $"      <td style=\"padding: 4px 0; color: #000000; font-size: 13.5px;\"><code style=\"background-color: #ffffff; border: 1px solid #eaeaea; padding: 2px 6px; border-radius: 4px; font-family: 'Geist Mono', monospace; font-size: 12px;\">Diitra2026*</code></td>" +
                        $"    </tr>" +
                        $"  </table>" +
                        $"  <p style=\"margin: 0; font-size: 12px; color: #666666; font-style: italic; line-height: 1.4;\">* Por motivos de seguridad, es aconsejable cambiar su contraseña temporal una vez que haya ingresado al sistema.</p>" +
                        $"</div>";
