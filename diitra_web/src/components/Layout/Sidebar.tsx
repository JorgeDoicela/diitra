import { Home, ClipboardList, PenTool, BarChart3, Settings, ShieldCheck, Search, Sun, Moon, Users, LogOut, Award, X, Activity, ListChecks, Bell, Gavel, ExternalLink, Mail, Info, AlertTriangle, TrendingUp, GraduationCap, Globe, Calendar, Tag, BookOpen, Loader2, Trash2 } from 'lucide-react';
...
const Sidebar = ({
    ...
    const allMenuItems: MenuItem[] = [
        ...
        { name: 'Evaluación', icon: Gavel, path: '/evaluacion-pares', roles: ['DIITRA_ADMIN'], group: 2 },
