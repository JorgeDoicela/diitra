...
export const ProgressReportSection: React.FC<ProgressReportSectionProps> = ({
    ...
    const showHitos = config?.showHitosCompletados !== false;
    const showEvidencias = config?.showEvidencias !== false;
    const showPresupuesto = config?.showPresupuestoEjecutado !== false;
