...
function buildStaticItems(navigate: ReturnType<typeof useNavigate>, isAdmin: boolean, isSuperAdmin: boolean, isDocente: boolean, isEstudiante: boolean, isRevisor: boolean): SearchItem[] {
    return [
        ...
        { id: 'innovacion', label: 'Innovación y Transferencia', description: 'Proyectos institucionales de innovación y transferencia tecnológica', category: 'Navegación', icon: Sparkles, path: '/innovacion', shortcut: 'I', roles: ['ANY'], keywords: ['innovacion', 'transferencia', 'tecnologia', 'proyectos', 'propuestas', 'protocolo'], boost: 9 },
        ...
        { id: 'plantillas', label: isAdmin ? 'Editor de Plantillas' : 'Formatos', description: isAdmin ? 'Diseñar y maquetar plantillas de documentos oficiales' : 'Catálogo institucional de formatos y plantillas descargables', category: isAdmin ? 'Administración' : 'Navegación', icon: FileCode2, path: '/plantillas', roles: ['ANY'], keywords: ['plantillas', 'templates', 'formatos', 'editor', 'documentos', 'formatos oficiales', 'oficiales', 'descargar'], boost: 7 },
        ...
        // ── Acciones Rápidas ──────────────────────────────────────────
        { id: 'feedback-modal', label: 'Reportar Incidencia (Soporte)', description: 'Reportar fallos en el sistema, datos faltantes o contactar por WhatsApp', category: 'Acciones Rápidas', icon: MessageSquarePlus, action: () => window.dispatchEvent(new CustomEvent('diitra-open-feedback')), roles: ['ANY'], keywords: ['incidencia', 'soporte', 'problema', 'whatsapp', 'error', 'bug', 'reporte', 'feedback', 'ayuda'], boost: 10 },
