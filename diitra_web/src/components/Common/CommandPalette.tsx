...
function buildStaticItems(navigate: ReturnType<typeof useNavigate>, isAdmin: boolean, isDocente: boolean, isEstudiante: boolean, isRevisor: boolean): SearchItem[] {
    return [
        ...
        { id: 'investigacion', label: 'Proyectos de investigación', description: 'Repositorio de proyectos de investigación institucionales', category: 'Navegación', icon: ClipboardList, path: '/investigacion', shortcut: 'P', roles: ['DIITRA_ADMIN', 'DIITRA_DOCENTE', 'DOCENTE_INV'], keywords: ['proyectos', 'investigacion', 'research', 'i+d', 'ciencia'], boost: 9 },
        ...
        // ── Administración ────────────────────────────────────────────
        { id: 'analiticas', label: 'Analíticas de Investigación', description: 'Métricas CACES, indicadores y producción académica', category: 'Administración', icon: BarChart3, path: '/analiticas', shortcut: 'A', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['analitica', 'metricas', 'estadisticas', 'caces', 'kpi', 'reporte'], boost: isAdmin ? 9 : 0 },
        ...
        { id: 'auditoria', label: 'Auditoría del Sistema', description: 'Registro de acciones y cambios en el sistema', category: 'Administración', icon: Activity, path: '/auditoria', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['auditoria', 'logs', 'forense', 'eventos', 'historial'], boost: isAdmin ? 7 : 0 },
        ...
        { id: 'correos', label: 'Correos institucionales', description: 'Administrar y enviar plantillas de correo del sistema', category: 'Administración', icon: Mail, path: '/admin/emails', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['correos', 'emails', 'plantillas', 'smtp'], boost: 4 },
        // ── Parámetros Normativos ───────────────────────────────────────
        { id: 'parametros-normativos', label: 'Parámetros Normativos', description: 'Líneas de investigación, períodos académicos e indicadores CACES', category: 'Parámetros Normativos', icon: Settings, path: '/parametros-normativos', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['parametros', 'normativos', 'caces', 'lineas', 'periodos', 'catalogos'], boost: isAdmin ? 6 : 0 },
        { id: 'config-lineas', label: 'Líneas de Investigación', description: 'Administrar líneas y áreas del conocimiento', category: 'Parámetros Normativos', icon: BookOpen, path: '/parametros-normativos?tab=lineas', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['lineas', 'areas', 'conocimiento', 'tematica'], boost: 3 },
        { id: 'config-periodos', label: 'Períodos Académicos', description: 'Gestionar ciclos y períodos vigentes', category: 'Parámetros Normativos', icon: Calendar, path: '/parametros-normativos?tab=periodos', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['periodos', 'ciclos', 'semestre', 'calendario'], boost: 3 },
        { id: 'config-productos', label: 'Tipos de Producto', description: 'Categorías de productos de investigación', category: 'Parámetros Normativos', icon: Tag, path: '/parametros-normativos?tab=productos', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['productos', 'tipos', 'articulos', 'patentes', 'publicaciones'], boost: 3 },
        { id: 'config-dominios', label: 'Dominios Académicos', description: 'Áreas del conocimiento y dominios científicos', category: 'Parámetros Normativos', icon: Globe, path: '/parametros-normativos?tab=dominios', roles: ['DIITRA_ADMIN', 'ADMIN_SISTEMA'], keywords: ['dominios', 'disciplinas', 'ciencias'], boost: 3 },
