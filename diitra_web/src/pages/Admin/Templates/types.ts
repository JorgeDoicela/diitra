...
export const DEFAULT_TECHNICAL_SUBSECTIONS: TechnicalSubsection[] = [
    {
        ...
        numberPrefix: '',
        title: 'ANTECEDENTES ESPECIFICOS DE LA PROBLEMÁTICA',
        placeholder: '[Identificar y analizar estudios previos, datos relevantes y casos similares que evidencien la existencia y magnitud del problema abordado en el proyecto. Se debe incluir información contextual que respalde la necesidad de la propuesta, citando fuentes en formato APA 7ª edición. DETALLAR EN DOS PÁRRAFO DE 8 A 12 LÍNEAS MÍNIMO]',
        requirementText: 'DETALLAR EN DOS PÁRRAFO DE 8 A 12 LÍNEAS MÍNIMO',
        enabled: true,
        scribanVariable: 'antecedentes',
        legacyKey: 'showAntecedentes',
        colSpan: 2,
        variant: 'banner_navy',
        hasContent: true
    },
    {
        id: 'sec_descripcion',
        fieldKey: 'DescripcionProyecto',
        numberPrefix: '',
        title: 'DESCRIPCIÓN DEL PROYECTO',
        placeholder: '[Definir el propósito del proyecto, detallando qué se pretende lograr y cuál es su impacto esperado. Además, delimitar el alcance, especificando los límites, las áreas involucradas y los aspectos que serán abordados dentro de la ejecución del proyecto. DETALLAR EN UN PÁRRAFO DE 8 A 12 LÍNEAS MÍNIMO]',
        requirementText: 'DETALLAR EN UN PÁRRAFO DE 8 A 12 LÍNEAS MÍNIMO',
        enabled: true,
        scribanVariable: 'descripcion_proyecto',
    ...
    {
        id: 'sec_objetivo_general',
        fieldKey: 'ObjetivoGeneral',
        numberPrefix: '',
        title: 'GENERAL',
        placeholder: '• [Oraciones cortas, coherentes y concisas]\nVERBO EN INFINITIVO + ¿QUÉ? + ¿CÓMO? + ¿PARA QUÉ? (+ PLAZO OPCIONAL)',
        requirementText: 'VERBO EN INFINITIVO + ¿QUÉ? + ¿CÓMO? + ¿PARA QUÉ? (+ PLAZO OPCIONAL)',
        enabled: true,
        scribanVariable: 'objetivo_general',
        legacyKey: 'showObjetivoGeneral',
        colSpan: 1,
        variant: 'banner_navy',
        hasContent: true,
        parentId: 'sec_banner_objetivos'
    },
    {
        id: 'sec_objetivos_especificos',
        ...
        requirementText: 'INFINITIVO + ACCIÓN ESPECÍFICA + MEDIO O METODOLOGÍA + PROPÓSITO (+ PLAZO OPCIONAL)',
        enabled: true,
        scribanVariable: 'objetivos_especificos',
        legacyKey: 'showObjetivosEspecificos',
        colSpan: 1,
        variant: 'banner_navy',
        hasContent: true,
        parentId: 'sec_banner_objetivos'
    },
    {
        ...
        placeholder: '[Los objetivos de desarrollo sostenible son 17 el proyecto de investigación debe estar alineado a algunos de los objetivos.]\nhttps://www.un.org/sustainabledevelopment/es/objetivos-de-desarrollo-sostenible/\nEl proyecto se encuentra alineado bajo los siguientes objetivos:',
        requirementText: 'Alineación con Objetivos de Desarrollo Sostenible ONU',
        enabled: true,
        scribanVariable: 'objetivos_desarrollo_sostenible',
        legacyKey: 'showOds',
        colSpan: 2,
        variant: 'standard',
        hasContent: true
    ...
    {
        id: 'sec_marco_teorico',
        fieldKey: 'MarcoTeorico',
        numberPrefix: '',
        title: 'MARCO TEÓRICO',
        placeholder: '[Describir los conceptos clave, antecedentes y fundamentos teóricos que respaldan el proyecto, incluyendo referencias a estudios previos, normativas o metodologías relacionadas. EL TEXTO MÁXIMO DEBE ABARCAR DOS PÁGINAS, CITAR USANDO NORMAS APA 7MA EDICIÓN]',
        requirementText: 'EL TEXTO MÁXIMO DEBE ABARCAR DOS PÁGINAS, CITAR USANDO NORMAS APA 7MA EDICIÓN',
        enabled: true,
        scribanVariable: 'marco_teorico',
        legacyKey: 'showMarcoTeorico',
        colSpan: 2,
        variant: 'standard',
        hasContent: true
    },
    {
        ...
        numberPrefix: '',
        title: 'METODOLOGÍA',
        placeholder: '[Describir el enfoque metodológico, las etapas del proyecto si este las tuviera, detalle de los procedimientos DETALLAR EN MÍNIMO 2 PÁRRAFOS DE 5 LÍNEAS, recursos y el tiempo estimado para alcanzar los objetivos DETALLAR EN MÍNIMO 2 PÁRRAFOS DE 5 LÍNEAS]',
        requirementText: 'DETALLAR EN MÍNIMO 2 PÁRRAFOS DE 5 LÍNEAS',
        enabled: true,
        scribanVariable: 'metodologia',
        legacyKey: 'showMetodologia',
        colSpan: 2,
        variant: 'standard',
        hasContent: true
    },
    {
        ...
        numberPrefix: '',
        title: 'EVALUACIÓN',
        placeholder: '[Describir los criterios e indicadores que se utilizarán para medir el cumplimiento de los objetivos, así como los métodos e instrumentos de evaluación. DETALLAR EN MÍNIMO 2 PÁRRAFOS DE 5 LINEAS, PARA PROFUNDIZAR LOS ASPECTOS RELACIONADOS CON INTRUMENTOS Y METODOLOGÍA]',
        requirementText: 'DETALLAR EN MÍNIMO 2 PÁRRAFOS DE 5 LINEAS',
        enabled: true,
        scribanVariable: 'evaluacion',
        legacyKey: 'showEvaluacion',
        colSpan: 2,
        variant: 'standard',
        hasContent: true
    }
...
export const DEFAULT_PROGRESS_HEADER_FIELDS: ProgressHeaderField[] = [
    ...
    { id: 'ph_tipo', fieldKey: 'TipoInvestigacion', label: 'Tipo de Investigación', scribanVariable: 'tipo_investigacion', enabled: true, colSpan: 1, fieldType: 'checkbox_group', options: ['BÁSICA PURA', 'BÁSICA ORIENTADA', 'APLICADA', 'DESARROLLO EXPERIMENTAL'] },
