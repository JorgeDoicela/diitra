...
export type AnalyticsTab = 'general' | 'caces' | 'planificador' | 'productos';
...
export const useAnalyticsState = () => {
    ...
    const activeTab: AnalyticsTab = (tabParam === 'general' || tabParam === 'caces' || tabParam === 'planificador' || tabParam === 'productos')
        ? tabParam
        : 'general';
