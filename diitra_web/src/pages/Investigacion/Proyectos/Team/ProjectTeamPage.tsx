...
import { useProjectTeam } from '../Workspace/hooks/useProjectTeam';
import TeamManagement from '../Workspace/components/TeamManagement';
import DirectorTransferModal from '../Workspace/components/DirectorTransferModal';
    ...
    useEffect(() => {
        ...
        const fetchProject = async () => {
            try {
                ...
                setProject(res.data);
                team.populateTeamFromProject(res.data);
            } catch (err: any) {
                console.error('[ProjectTeamPage] Error fetching project:', err);
        ...
        return (
            <div className="flex-1 bg-bg-deep min-h-screen flex items-center justify-center p-6 text-center">
                <div className="bento-card bg-surface p-8 max-w-md space-y-4 shadow-xl border border-border-thin">
                    <h3 className="text-red-500 font-bold text-base">Error al Cargar Equipo</h3>
        ...
        <div className="flex-1 bg-bg-deep min-h-screen text-text-main p-4 md:p-8 space-y-6">
            ...
            <div className="space-y-3 border-b border-border-thin pb-4">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-text-dim animate-fade-in">
                    ...
                    <ChevronRight size={12} className="opacity-50 shrink-0" />
                    <span className="text-text-main font-semibold">Equipo de Investigación</span>
                </nav>
            ...
            {/* Módulo Principal de Gestión de Equipo */}
            ...
            {/* Modal de Relevo / Traspaso de Director */}
            ...
            {/* Drawer de Detalle de Grupo Formal de Investigación */}
            <GroupDetailDrawer
