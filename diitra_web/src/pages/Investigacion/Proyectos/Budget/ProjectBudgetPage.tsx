...
export const ProjectBudgetPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchProject = async () => {
            try {
                ...
                console.error('[ProjectBudgetPage] Error fetching project:', err);
        ...
        return (
            <div className="flex-1 bg-bg-deep min-h-screen flex items-center justify-center p-6 text-center">
                <div className="bento-card bg-surface p-8 max-w-md space-y-4 shadow-xl border border-border-thin">
                    <h3 className="text-red-500 font-bold text-base">Error al Cargar Presupuesto</h3>
    ...
    return (
        <div className="flex-1 bg-bg-deep min-h-screen text-text-main p-4 md:p-8 space-y-6">
            ...
            {/* Módulo Principal de Presupuesto en Vista Completa Dedicada */}
            {projectUuid && (
                <div className="animate-fade-in">
                    <ProjectBudgetModule
                        ...
                        directorNombre={project?.directorNombre || project?.director_nombre || ''}
                    />
                </div>
            )}
        </div>
